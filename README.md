...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sunkit-image-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15606&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sunkit-image-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sunkit-image` can be installed with:

```
conda install sunkit-image
```

It is possible to list all of the versions of `sunkit-image` available on your platform with:
